    ...
    <div style={{
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px", paddingBottom: "10px", borderBottom: `1px solid ${th.border}` }}>
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{ display: "inline-block", width: "6px", height: "6px", borderRadius: "50%", background: th.accent }} />
        ...
        <div style={{ display: "flex", gap: "8px" }}>
          ...
          {["CSV","JSON","PDF"].map(fmt => (
            <button key={fmt} style={{
              ...
              color: th.textMuted, padding: "3px 10px", borderRadius: "4px",
      ...
      <div style={{ marginBottom: "10px", display: "flex", alignItems: "center", gap: "8px" }}>
        <span style={{ color: th.textFaint, fontSize: "9px", letterSpacing: "2px" }}>{data?.type?.toUpperCase()}</span>
        <span style={{ color: th.accent, background: th.accentSubtle, border: `1px solid ${th.border}`, padding: "2px 8px", borderRadius: "3px" }}>{data?.indicator}</span>
      </div>

      {/* Score */}
      <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "12px" }}>
        <VerdictBadge verdict={data?.verdict?.threat_level} />
        <div style={{ flex: 1 }}>
          ...
          <div style={{ height: "3px", background: "rgba(255,255,255,0.06)", borderRadius: "2px", overflow: "hidden" }}>
            <div style={{ height: "100%", width: `${score}%`, background: `linear-gradient(90deg, ${scoreColor}88, ${scoreColor})`, borderRadius: "2px" }} />
          </div>
        </div>
      </div>
    </div>
